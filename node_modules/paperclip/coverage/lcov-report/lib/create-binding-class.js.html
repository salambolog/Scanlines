...
<html lang="en">
<head>
    <title>Code coverage report for lib/create-binding-class.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/create-binding-class.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; create-binding-class.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!update) <span class="cstat-no" title="statement not covered" >update = <span class="fstat-no" title="function not covered" >function() {</span> };</span>
&nbsp;
  /**
   */
&nbsp;
  function Binding(ref, view) {
    ...
    this.attributeClasses = this.options.attributes || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    this.initialize();
    this.attrBindings     = {};
  }
&nbsp;
...
&nbsp;
     ...
     */
&nbsp;
    update2: update || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function() {</span> },</span>
&nbsp;
    /**
     */
&nbsp;
